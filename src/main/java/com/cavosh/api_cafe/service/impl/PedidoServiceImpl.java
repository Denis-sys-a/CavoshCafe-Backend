...
public class PedidoServiceImpl implements PedidoService {
        ...
        public PedidoResponseDTO crearPedidoDesdeCarrito(CheckoutRequestDTO dto) {
                ...
                for (CarritoItem carritoItem : carrito.getItems()) {
                        ...
                        carritoItem.getOpciones()
                                        .forEach(opcion -> pedidoItem.getOpciones().add(PedidoItemOpcion.builder()
                                                        .pedidoItem(pedidoItem)
                                                        .nombreOpcion(opcion.getProductoOpcionValor()
                                                                        .getProductoOpcion().getNombreOpcion())
                                                        .nombreValor(opcion.getProductoOpcionValor().getNombreValor())
                                                        .modificadorPrecio(opcion.getProductoOpcionValor()
                                                                        .getModificadorPrecio())
                                                        .build()));
                ...
                BigDecimal subtotal = pedido.getItems().stream()
                                .map(pedidoItem -> pedidoItem.getSubtotal())
                ...
                if (dto.getCodigoPromocional() != null && !dto.getCodigoPromocional().isBlank()) {
                        CodigoPromocional promo = codigoPromocionalRepository
                                        ...
                                        .orElseThrow(() -> new InvalidPromoCodeException(
                                                        "Código promocional inválido o inactivo"));
                        ...
                        descuento = (promo.getTipoDescuento() == TipoDescuento.PORCENTAJE)
                                        ? subtotal.multiply(promo.getValorDescuento()).divide(BigDecimal.valueOf(100),
                                                        2,
